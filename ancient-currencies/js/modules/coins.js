...
export const Coins = {
    ...
    commodities_filter: function (coin) {
        return coin.commodity_or_service != "x";
    },
    ...
    get_filtered_list: function (without_commodities = false) {

        if(without_commodities){
            return Coins.get_list()
                .filter(Coins.commodities_filter)
    ...
    build_dropdown: function () {
        ...
        let coins = Coins.get_filtered_list("without commodities");
